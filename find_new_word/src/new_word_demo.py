...
@file: new_word_demo.py
@time: 11/29/18 3:04 PM
"""
...
# 保存结果并输出
pd.DataFrame(pd.concat(t[1:]).sort_values(ascending=False)).to_csv('../data/result.txt', header=False)
